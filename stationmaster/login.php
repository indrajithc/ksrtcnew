 ...
 * @Last Modified time: 2018-11-26 17:09:19
 */
...
if(isset($_POST['login'])){
	...
	$stmnt='select * from stationmaster where depotusename = :username and depotpswd = :password';
	$params=array( 
		':username'  =>  $username,
		':password'  =>  $password
	);
	...
	if($user){
		...
		$_SESSION[SYSTEM_NAME . 'userid0']=$user[0]['stationmasterid'];


		$_SESSION[SYSTEM_NAME . 'userid1']= selectFromTable( 'depoid', 'depot',  "depotname = '".$user[0]['depotname']."' LIMIT 1" , $db);
...
<!DOCTYPE html>
<html lang="en"  ng-app="app-stationmaster">
...
<head>
	...
	<link rel="stylesheet" href="stationmaster/css/style.css">  
	<link rel="stylesheet" href="stationmaster/css/style_01.css">
...
<body>
	...
	<div class="login-page">
		<h4 class="w-100 text-center text-white">Stationmaster 	</h4>
		<div class="form">
	...
	<!-- <div class="container-scroller">
		<div class="container-fluid page-body-wrapper full-page-wrapper">
								...
								<div class="form-group d-flex justify-content-between">
									...
									<div class="form-group">
										<button class="btn btn-block g-login">
											Log in with Google<img class="ml-3" src="https://www.bootstrapdash.com/demo/star-stationmaster-pro/src/assets/images/file-icons/icon-google.svg" alt=""></button>
										</div>
			...
			<script src="stationmaster/js/main.js"></script>
