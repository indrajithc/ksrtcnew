 ...
 * @Last Modified time: 2018-11-25 10:49:31
 */
			...
			<tbody>
				...
				<?php foreach ($details as $key => $value): ?>
					...
					<tr>
						...
						<td><?php echo $value['conductorid']; ?></td>
					...
					<!-- 	<td >
						...
						<td >
							<form accept="" method="post">
								<input type="hidden" name="id" value="<?php echo indexMe( (int) isit('conductor_id', $value, 0)); ?>">
