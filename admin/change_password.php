 ...
 * @Last Modified time: 2018-11-25 09:52:14
 */
...
if (isset($_POST['update'])) {
	...
	$temp = selectFromTable('*', 'login', ' password ="'. $password0 .'" AND userid =' . $_SESSION[SYSTEM_NAME."userid0"] , $db );
	...
	//	'password' => hash('sha256', encrypt($password1)) 
		...
		$result = updateTable('login', $params, 'userid =' . $_SESSION[SYSTEM_NAME."userid0"], $db );
