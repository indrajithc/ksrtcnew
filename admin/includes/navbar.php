...
<!-- icon url https://cdn.materialdesignicons.com/3.0.39/  -->
...
<li class="nav-item">
	...
	<div class="collapse" id="dashboard-dropdown">
		<ul class="nav flex-column sub-menu">
			<li class="nav-item">
				<a class="nav-link  text-capitalize" href="admin/dashboard">Dashboard 1</a>
			</li>
			<li class="nav-item">
				<a class="nav-link  text-capitalize" href="admin/#">Dashboard 2</a>
			</li>
		</ul>
	</div>
</li>
...
<li class="nav-item">
	<a class="nav-link" href="admin/#">
		<i class="menu-icon mdi mdi-trackpad"></i>
		<span class="menu-title  text-capitalize">Widgets</span>
	</a>
</li>
